...
const CONTACT_INFO = {
    nequi: { number: '311 634 1263', name: 'Nequi', color: 'bg-orange-500 hover:bg-orange-600' }, // <--- ¡ACTUALIZA TU NÚMERO!
    daviplata: { number: '311 634 1263', name: 'DaviPlata', color: 'bg-red-600 hover:bg-red-700' }, // <--- ¡ACTUALIZA TU NÚMERO!
};
